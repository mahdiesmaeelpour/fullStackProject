...
export class JoinGameComponent implements OnInit {
  ...
  SectioinArray_game: any = ['Game_1', 'Game_2', 'Game_3', 'Game_4', 'Game_5'];
  ...
  constructor(
    ...
    this.playerApi.Getplayer(id).subscribe(data => {
      ...
      this.playerForm = this.fb.group({
        ...
        player_status: [false, [Validators.required]],
  ...
  updatePlayerForm() {
    ...
    var id = this.actRoute.snapshot.paramMap.get('id');
    if (window.confirm('Are you sure you want to Join to this Game?')) {
